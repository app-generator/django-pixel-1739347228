...
- [Free Support](https://app-generator.dev/ticket/create/?generated_repo=https://github.com/app-generator/django-pixel-1739347228) via `eMail` and `Discord`
...
```bash
$ git clone https://github.com/django-pixel-1739347228.git
$ cd django-pixel-1739347228
```
